...
This is a Project that allows a user to create a profile and add pictures to that profile. They can add images, enter their name and give a user description. 
